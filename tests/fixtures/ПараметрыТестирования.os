...
Функция Вывод_ПрофилиБезопасностиСписок()
	...
	Профили = РазобратьВыводКоманды(ВозвращаемыеЗначения["НазначенияФункциональности"]);
...
Функция Вывод_СчетчикиРесурсовЗначения()
	...
	ПараметрыЗапуска.Добавить(Перечисления.РежимыАдминистрирования.СчетчикиРесурсов);
...
КонецФункции // Вывод_СчетчикиРесурсовЗначения()
...
Процедура Инициализация()
	...
	ПараметрыКластера.СчетчикиРесурсов.Значения  = Вывод_СчетчикиРесурсовЗначения();
