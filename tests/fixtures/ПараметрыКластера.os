...
Функция Вывод_ИБСписок()
	...
	Возврат Новый Структура("ПараметрыКоманды, ВыводКоманды", ПараметрыЗапуска.ПараметрыКоманды("Список"), ВыводКоманды);
...
Функция Вывод_ИБСокращенныеПараметры()
	...
	Для Каждого ТекИб Из ИБ Цикл
		...
		Результат.Добавить(Новый Структура("ПараметрыКоманды, ВыводКоманды", ПараметрыЗапуска.ПараметрыКоманды("Описание"), ВыводКоманды));
...
Функция Вывод_ИБПолныеПараметры()
	...
	Для Каждого ТекИб Из ИБ Цикл
		...
		Результат.Добавить(Новый Структура("ПараметрыКоманды, ВыводКоманды", ПараметрыЗапуска.ПараметрыКоманды("ПолноеОписание"), ВыводКоманды));
...
Функция Вывод_ИБДобавить()
	...
	Возврат Новый Структура("ПараметрыКоманды, ВыводКоманды", ПараметрыЗапуска.ПараметрыКоманды("Добавить"), ВыводКоманды);
