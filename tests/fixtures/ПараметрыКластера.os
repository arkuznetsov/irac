...
Функция Вывод_ИБСписок()
	...
	ПараметрыЗапуска = Новый КомандыОбъекта("infobase", "Список", ПараметрыКоманды);
...
Функция Вывод_ИБСокращенныеПараметры()
	...
	Для Каждого ТекИб Из ИБ Цикл
		...
		ПараметрыЗапуска = Новый КомандыОбъекта("infobase", "Описание", ПараметрыКоманды);
...
Функция Вывод_ИБПолныеПараметры()
	...
	Для Каждого ТекИб Из ИБ Цикл
		...
		ПараметрыЗапуска = Новый КомандыОбъекта("infobase", "ПолноеОписание", ПараметрыКоманды);
...
Функция Вывод_ИБДобавить()
	...
	ПараметрыЗапуска = Новый КомандыОбъекта("infobase", "Добавить", ПараметрыКоманды);
