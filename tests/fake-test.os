...
Процедура ТестДолжен_СоздатьКластер() Экспорт
	...
	Кластер = Новый Кластер(АгентКластера, "");
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляКаталог() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.Каталог);
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляCOMКласс() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.COMКласс);
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляКомпонента() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.Компонент);
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляМодуль() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.Модуль);
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляПриложение() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.Приложение);
...
Процедура ТестДолжен_СоздатьОбъектыПрофиляИнтернетРесурс() Экспорт
	...
	Профиль = Новый ПрофильБезопасности(АгентКластера, Кластер, "");
	ОбъектПрофиля = Новый ОбъектыПрофиля(АгентКластера, Кластер, Профиль, Перечисления.ВидыОбъектовПрофиляБезопасности.ИнтернетРесурс);
