...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестДолжен_ПолучитьВерсиюАгента");
...
// Процедура - тест
//
Процедура ТестДолжен_ПолучитьВерсиюАгента() Экспорт
	
	ПараметрыТестирования.УстановитьВыводИсполнителяКоманд(АгентКластера.ИсполнительКоманд(), "Версия");
	...
	Версия = АгентКластера.Версия();

	Утверждения.ПроверитьРавенство(Лев(Версия, 3), "8.3", "Не удалось получить версию агента кластера");

КонецПроцедуры // ТестДолжен_ПолучитьВерсиюАгента()
