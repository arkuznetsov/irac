...
Процедура ПередЗапускомТеста() Экспорт
	...
	ПортСервера = ПараметрыТестирования.Параметры().Агент_Порт;
...
Процедура ТестДолжен_ПолучитьСписокАдминистраторовКластера() Экспорт
	...
	ПараметрыТестирования.УстановитьВыводИсполнителяКоманд(АгентКластера.ИсполнительКоманд(), "Кластеры.Администраторы.Список");
