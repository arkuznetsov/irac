...
Процедура ВывестиСписокБаз()
	...
	СписокКластеров = Кластеры.ПолучитьСписок();
	Для Каждого ТекЭлемент Из СписокКластеров Цикл

		Кластер = ТекЭлемент.Значение[0];
		...
		Сеансы1 = Кластер.Сеансы().Получить(Отбор);
