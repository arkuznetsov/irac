...
Функция СтрокаПараметровКоманды(ПараметрыКоманды, СтрокаДляЛога = "") Экспорт
	...
	Для Каждого Параметр Из ПараметрыКоманды Цикл
		Если ТипЗнч(Параметр) = Тип("Структура") Тогда
			...
			Если Параметр.Свойство("Приватный") И Параметр.Приватный Тогда
				ПараметрДляЛога = СтрШаблон("--%1=%2", Параметр.Параметр, "******");
			Иначе
				ПараметрДляЛога = СтрШаблон("--%1=%2", Параметр.Параметр, Параметр.Значение);
			КонецЕсли;
		Иначе
			ПараметрДляВыполнения = Параметр;
			ПараметрДляЛога       = Параметр;
		КонецЕсли;
		СтрокаПараметров = СтрШаблон("%1 %2", СтрокаПараметров, ПараметрДляВыполнения);
		СтрокаДляЛога    = СтрШаблон("%1 %2", СтрокаДляЛога, ПараметрДляЛога);
	КонецЦикла;

	Возврат СтрокаПараметров;

КонецФункции // СтрокаПараметровКоманды()
