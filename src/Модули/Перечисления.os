...
Процедура Инициализация()
	...
	// Перечисление.РежимыДоступа
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "Список"			, "list");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "ПолныйДоступ"	, "full");
	
	// Перечисление.ВидыОбъектовПрофиляБезопасности
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "Каталог"			, "directory");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "COMКласс"		, "com");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "Компонент"		, "addin");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "Модуль"			, "module");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "Приложение"		, "app");
	ДобавитьЗначениеПеречисления(РежимыДоступа		, "ИнтернетРесурс"	, "inet");
