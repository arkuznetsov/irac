...
Процедура Инициализация()
	...
	ЗаполнитьДействияСБазойСУБДПриУдалении();
...
// Процедура - заполняет значения перечисления ДействияСБазойСУБДПриУдалении
//
Процедура ЗаполнитьДействияСБазойСУБДПриУдалении()

	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "Очистить"            , "clear");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "Удалить"             , "drop");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "ОставитьБезИзменений", "leave-as-is");

КонецПроцедуры // ЗаполнитьДействияСБазойСУБДПриУдалении()

// Процедура - заполняет значения перечисления Приложения
//
Процедура ЗаполнитьПриложения()

	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "Конфигуратор"        , "Designer");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "ТонкийКлиент"        , "1CV8C");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "ТолстыйКлиент"       , "1CV8");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "COMСоединение"       , "COMConnection");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "РасширениеWebСервера", "WebServerExtension");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "Планировщик"         , "JobScheduler");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "ФоновоеЗадание"      , "BackgroundJob");
	ДобавитьЗначениеПеречисления(ВидыОбъектовПрофиляБезопасности        , "КонсольКластера"     , "SrvrConsole");

КонецПроцедуры // ЗаполнитьПриложения()
