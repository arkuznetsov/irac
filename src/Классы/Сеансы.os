...
Процедура ПриСозданииОбъекта(АгентКластера, Кластер, ИБ = Неопределено)
	...
	ПараметрыОбъекта = Новый КомандыОбъекта("session");
...
//
Процедура Удалить(Знач Сеанс, ДействияСБазойСУБД = "") Экспорт
	...
	ПараметрыКоманды.Вставить("ИдентификаторСеанса"      , Сеанс.Ид());
	...
	Если НЕ КодВозврата = 0 Тогда
		ВызватьИсключение СтрШаблон("Ошибка удаления сеанса ""%1"": %2",
		                            Сеанс.Ид(),
