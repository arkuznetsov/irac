...
Процедура ОбновитьДанные(ОбновитьПринудительно = Ложь) Экспорт
	...
	ВремИБ = Новый ИнформационныеБазы(Кластер_Агент, Кластер_Владелец);
...
Функция Получить(ИмяПоля, ОбновитьПринудительно = Ложь) Экспорт
	...
	Если ЗначениеПоля = Неопределено Тогда
		...
		ВремИБ = Новый ИнформационныеБазы(Кластер_Агент);

		СтруктураПараметров = ВремИБ.ПолучитьСтруктуруПараметровОбъекта("ИмяПоляРАК");
