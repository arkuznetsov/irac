...
Процедура ПриСозданииОбъекта(АгентКластера, Ид, Администратор = "", ПарольАдминистратора = "")
	...
	Кластер_Администраторы = Новый АдминистраторыКластера();
	Кластер_Серверы = Новый Серверы();
	Кластер_Менеджеры = Новый МенеджерыКластера();
	Кластер_ИБ = Новый ИнформационныеБазы();
	Кластер_Сеансы = Новый Сеансы();
