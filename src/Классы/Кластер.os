...
Процедура ОбновитьДанные(ОбновитьПринудительно = Ложь) Экспорт
	...
	Кластер_Параметры = Новый Соответствие();
...
Функция Сервер() Экспорт
	...
	Если Служебный.ТребуетсяОбновление(Кластер_Сервер, МоментАктуальности, ПериодОбновления) Тогда
		ОбновитьДанные(Истина);
	КонецЕсли;
...
Функция Порт() Экспорт
	...
	Если Служебный.ТребуетсяОбновление(Кластер_Порт, МоментАктуальности, ПериодОбновления) Тогда
		ОбновитьДанные(Истина);
	КонецЕсли;
