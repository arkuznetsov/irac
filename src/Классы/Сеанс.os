...
Процедура ОбновитьДанные(ОбновитьПринудительно = Ложь) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(МассивРезультатов) Тогда
		Кластер_Владелец.Сеансы().ОбновитьДанные(Истина);
		Возврат;
	КонецЕсли;
...
//   РежимОбновления         - Булево, Число  - Истина (1) - обновить данные сеанса принудительно (вызов RAC)
//                                              Ложь (0) - обновить данные сеанса только по таймеру
//                                              -1 - не обновлять данные сеанса
//
// Возвращаемое значение:
