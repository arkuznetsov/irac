...
Функция ПолучитьСписок(Знач ПоляУпорядочивания = "", ОбновитьПринудительно = Ложь) Экспорт
	...
	АдминистраторыАгента = Элементы.ПолучитьСписок(ПоляУпорядочивания, ОбновитьПринудительно);
...
//   
// Параметры:
//   Отбор				 	- Структура	- Структура отбора администраторов агента (<поле>:<значение>)
//   ОбновитьПринудительно 	- Булево	- Истина - принудительно обновить данные (вызов RAC)
//
// Возвращаемое значение:
...
Функция Получить(Отбор, ОбновитьПринудительно = Ложь) Экспорт
	...
	АдминистраторыАгента = Элементы.Получить(Отбор, ОбновитьПринудительно);
