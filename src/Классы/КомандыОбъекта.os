...
//
Процедура Параметры_НазначениеФункциональности_Общие() Экспорт
...
КонецПроцедуры // Параметры_НазначениеФункциональности_Общие()
...
Процедура Параметры_НазначениеФункциональности_Список() Экспорт
	...
	Параметры_НазначениеФункциональности_Общие();
...
//
Процедура Параметры_ПрофильБезопасности_Общие() Экспорт
...
КонецПроцедуры // Параметры_ПрофильБезопасности_Общие()
...
Процедура Параметры_ПрофильБезопасности_Список() Экспорт
	...
	Параметры_ПрофильБезопасности_Общие();
...
Процедура ЗаполнитьПолучениеПараметровОбъекта()
	...
	Для Каждого ТекКоманда Из ОписаниеКоманд Цикл
		...
		ИмяПроцедуры = "Параметры_" + СтрЗаменить(ТипОбъекта, ".", "_") + "_" + ТекКоманда.Ключ;
	...
	ПолучениеПараметровОбъекта.Вставить("ИмяТипа", ТипОбъекта);
	ПолучениеПараметровОбъекта.Вставить("Команды", ПолучениеПараметровКоманд);

	ПолучениеПараметровОбъектов = Новый Соответствие();
	ПолучениеПараметровОбъектов.Вставить(ВРег(ТипОбъекта), ПолучениеПараметровОбъекта);
