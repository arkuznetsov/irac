...
Процедура Добавить(Знач Имя, Знач ПараметрыАдминистратора = Неопределено, УстановитьТекущим = Ложь) Экспорт
	...
	Если НЕ ТипЗнч(ПараметрыАдминистратора) = Тип("Структура") Тогда
		ПараметрыАдминистратора = Новый Структура();
	КонецЕсли;
	...
	Иначе
		ПараметрыАдминистратора.Вставить("Пароль", "");
	КонецЕсли;
	...
	Если УстановитьТекущим Тогда
		Кластер_Владелец.УстановитьАдминистратора(Имя, ПараметрыАдминистратора.Пароль);
	КонецЕсли;
