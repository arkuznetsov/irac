...
Процедура ДополнитьДанные() Экспорт
	...
	Для Каждого ТекОписание Из МассивРезультатов Цикл
		...
		Иначе
			...
			Если НЕ СоединениеДляОбновления.ПолноеОписание() Тогда
...
Процедура ЗаполнитьСвойстваОбъекта(ОписаниеОбъекта, ПолноеОписание = Ложь) Экспорт
	Служебный.ЗаполнитьСвойстваОбъекта(ЭтотОбъект, Соединение_Свойства, ОписаниеОбъекта);
...
Функция ПолноеОписание() Экспорт
	...
	Если Служебный.ТребуетсяОбновление(Соединение_ПолноеОписание, МоментАктуальности, ПериодОбновления) Тогда
		ОбновитьДанные(Перечисления.РежимыОбновленияДанных.Принудительно);
	КонецЕсли;

	Возврат Соединение_ПолноеОписание;
